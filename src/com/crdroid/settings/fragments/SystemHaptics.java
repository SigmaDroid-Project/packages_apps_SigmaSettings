 ...
 */
public class SystemHaptics extends DashboardFragment {

    private static final String TAG = "SystemHaptics";
    private static final String KEY = "haptics_settings_category";
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.crdroid_settings_haptics;
    }

    @Override
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        final List<AbstractPreferenceController> controllers = new ArrayList<>();
        controllers.add(new SystemHapticsController(context));
        return controllers;
    }

    public static class SystemHapticsController extends AbstractPreferenceController
        ...
        public SystemHapticsController(Context context) {
            super(context);
            mContext = context;
        ...
        public void displayPreference(PreferenceScreen screen) {
            ...
            mBackIntensity = screen.findPreference(KEY_BACK_GESTURE_HAPTIC_INTENSITY);
            mBrightnessIntensity = screen.findPreference(KEY_BRIGHTNESS_SLIDER_HAPTICS_INTENSITY);
            mEdgeScrollingIntensity = screen.findPreference(KEY_EDGE_SCROLLING_HAPTICS_INTENSITY);
            mQsIntensity = screen.findPreference(KEY_QS_HAPTICS_INTENSITY);
            mQsTileIntensity = screen.findPreference(KEY_QS_TILE_HAPTICS_INTENSITY);
            mVolumeSliderIntensity = screen.findPreference(KEY_VOLUME_SLIDER_HAPTICS_INTENSITY);
            updateSettings();
        }
