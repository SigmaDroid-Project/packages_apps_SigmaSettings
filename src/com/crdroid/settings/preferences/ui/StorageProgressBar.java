...
public class StorageProgressBar extends ProgressBar  {
    ...
    private void init(Context context) {
        ...
        //storageText =  (TextView) context.getResources().getString(R.string.homepage_widget_storage_title);
        //final String storageText = context.getResources().getString(R.string.homepage_widget_storage_title);
       // storageText .setText(String.valueOf(storageText + " : ")).toUpperCase();
