...
import com.sigma.settings.fragments.buttons.ButtonBacklightBrightness;
import com.sigma.settings.fragments.buttons.PowerMenuActions;
import com.sigma.settings.preferences.LineageSystemSettingSeekBarPreference;
...
public class Buttons extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.sigma_settings_button);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.sigma_settings_button) {
