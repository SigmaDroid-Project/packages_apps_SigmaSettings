...
import com.sigma.settings.fragments.lockscreen.DozeSettings;
import com.sigma.settings.fragments.lockscreen.UdfpsSettings;
...
public class LockScreen extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.sigma_settings_lockscreen);
        ...
        if (mFingerprintManager == null || !mFingerprintManager.isHardwareDetected()) {
            ...
            //if (!Utils.isPackageInstalled(getContext(), "com.sigma.udfps.icons")) {
                interfaceCategory.removePreference(mUdfpsSettings);
            //}
            ...
            new BaseSearchIndexProvider(R.xml.sigma_settings_lockscreen) {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (mFingerprintManager == null || !mFingerprintManager.isHardwareDetected()) {
                        ...
                        //if (!Utils.isPackageInstalled(context, "com.sigma.udfps.icons")) {
                            keys.add(KEY_UDFPS_SETTINGS);
                        //}
